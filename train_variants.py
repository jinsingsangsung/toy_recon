...
def main():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', type=str, default='../hier_mambaconv/data/cifar-100-python', help='data path for vid')
    ...
    parser.add_argument('--model', default='base', help="model type", choices=['base', 's4', 's4d', 'mamba', 's4nd', 'hippo', 'transformer'])
...
def train(local_rank, args):
    ...
    if args.variant == "a":
        ...
        model = VariantsC(model=args.model, in_channels=3, out_channels=8, kernel_size=8)
    else:
